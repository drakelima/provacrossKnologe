...
class SimpleJsonRequest
{
    ...
    public static function get(string $url, array $parameters = null)
    {
        ...
        Cache::remember('getData', $expiracao, function(string $url, array $parameters = null) {
    ...
    {
        $expiracao = 1; //Em minutos
        Cache::remember('postData', $expiracao, function(string $url, array $parameters = null, array $data) {
    ...
    {
        $expiracao = 1; //Em minutos
        Cache::remember('putData', $expiracao, function(string $url, array $parameters = null, array $data) {
    ...
    {
        $expiracao = 1; //Em minutos
        Cache::remember('patchData', $expiracao, function(string $url, array $parameters = null, array $data) {
    ...
    {
        $expiracao = 1; //Em minutos
        Cache::remember('deleteData', $expiracao, function(string $url, array $parameters = null, array $data = null) {
